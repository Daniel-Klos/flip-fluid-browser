...
(() => {
  ...
  loadPackage({
    files: [
      { filename: "/gray_square.png", start: 0, end: 192 },
      { filename: "/white_circle.png", start: 192, end: 10542 },
      { filename: "/white_square_black_edges.png", start: 10542, end: 10748 },
    ],
    remote_package_size: 10748,
  });
})();
var arguments_ = [];
...
var ASM_CONSTS = {
  ...
  31830: () => document.getElementById("canvas").width,
  31882: () => parseInt(document.getElementById("canvas").style.width),
  31950: () => {
    document.exitFullscreen();
  },
  31977: () => {
  ...
  32096: () => document.getElementById("canvas").width,
  32148: () => screen.width,
  32173: () => {
    document.exitFullscreen();
  },
  ...
  32333: () => window.innerWidth,
  32359: () => window.innerHeight,
  32386: () => {
    if (document.fullscreenElement) return 1;
  },
  32432: () => document.getElementById("canvas").width,
  32484: () => parseInt(document.getElementById("canvas").style.width),
  32552: () => {
    if (document.fullscreenElement) return 1;
  },
  32598: () => document.getElementById("canvas").width,
  32650: () => screen.width,
  32675: () => window.innerWidth,
  32701: () => window.innerHeight,
  32728: () => {
    if (document.fullscreenElement) return 1;
  },
  32774: () => document.getElementById("canvas").width,
  32826: () => screen.width,
  32851: () => {
    document.exitFullscreen();
  },
  ...
  32924: () => document.getElementById("canvas").width,
  32976: () => parseInt(document.getElementById("canvas").style.width),
  33044: () => {
    document.exitFullscreen();
  },
  33071: ($0) => {
  ...
  33129: () => screen.width,
  33154: () => screen.height,
  33180: () => window.screenX,
  33207: () => window.screenY,
  33234: ($0) => {
  ...
  33788: () => window.innerWidth,
  33814: () => window.innerHeight,
  33841: () => {
...
function assignWasmExports(wasmExports) {
  Module["_main"] = _main = wasmExports["re"];
  Module["_malloc"] = _malloc = wasmExports["se"];
  Module["_free"] = _free = wasmExports["te"];
  __emscripten_stack_restore = wasmExports["ue"];
  __emscripten_stack_alloc = wasmExports["ve"];
  _emscripten_stack_get_current = wasmExports["we"];
  dynCalls["ii"] = dynCall_ii = wasmExports["xe"];
  dynCalls["vii"] = dynCall_vii = wasmExports["ye"];
  dynCalls["viii"] = dynCall_viii = wasmExports["ze"];
  dynCalls["viff"] = dynCall_viff = wasmExports["Ae"];
  dynCalls["viiiii"] = dynCall_viiiii = wasmExports["Be"];
  dynCalls["viiii"] = dynCall_viiii = wasmExports["Ce"];
  dynCalls["vidd"] = dynCall_vidd = wasmExports["De"];
  dynCalls["iiii"] = dynCall_iiii = wasmExports["Ee"];
  dynCalls["iiiiii"] = dynCall_iiiiii = wasmExports["Fe"];
  dynCalls["viiiiii"] = dynCall_viiiiii = wasmExports["Ge"];
  dynCalls["vi"] = dynCall_vi = wasmExports["He"];
  dynCalls["vffff"] = dynCall_vffff = wasmExports["Ie"];
  dynCalls["vf"] = dynCall_vf = wasmExports["Je"];
  dynCalls["viiiiiiii"] = dynCall_viiiiiiii = wasmExports["Ke"];
  dynCalls["viiiiiiiii"] = dynCall_viiiiiiiii = wasmExports["Le"];
  dynCalls["i"] = dynCall_i = wasmExports["Me"];
  dynCalls["vff"] = dynCall_vff = wasmExports["Ne"];
  dynCalls["v"] = dynCall_v = wasmExports["Oe"];
  dynCalls["viiiiiii"] = dynCall_viiiiiii = wasmExports["Pe"];
  dynCalls["iii"] = dynCall_iii = wasmExports["Qe"];
  dynCalls["vfi"] = dynCall_vfi = wasmExports["Re"];
  dynCalls["viif"] = dynCall_viif = wasmExports["Se"];
  dynCalls["vif"] = dynCall_vif = wasmExports["Te"];
  dynCalls["vifff"] = dynCall_vifff = wasmExports["Ue"];
  dynCalls["viffff"] = dynCall_viffff = wasmExports["Ve"];
  dynCalls["vfff"] = dynCall_vfff = wasmExports["We"];
  dynCalls["jiji"] = dynCall_jiji = wasmExports["Xe"];
  dynCalls["iidiiii"] = dynCall_iidiiii = wasmExports["Ye"];
  _asyncify_start_unwind = wasmExports["Ze"];
  _asyncify_stop_unwind = wasmExports["_e"];
  _asyncify_start_rewind = wasmExports["$e"];
  _asyncify_stop_rewind = wasmExports["af"];
}
var wasmImports = {
  f: ___assert_fail,
  q: ___cxa_throw,
  ...
  Kd: _emscripten_glBlendColor,
  Jd: _emscripten_glBlendEquation,
  Id: _emscripten_glBlendEquationSeparate,
  Hd: _emscripten_glBlendFunc,
  Gd: _emscripten_glBlendFuncSeparate,
  Fd: _emscripten_glBufferData,
  Ed: _emscripten_glBufferSubData,
  ...
  bb: _emscripten_glClipControlEXT,
  ...
  cb: _emscripten_glPolygonOffsetClampEXT,
  ...
  Q: _emscripten_set_click_callback_on_thread,
  S: _emscripten_set_fullscreenchange_callback_on_thread,
  ne: _emscripten_set_gamepadconnected_callback_on_thread,
  me: _emscripten_set_gamepaddisconnected_callback_on_thread,
  ...
  oe: _emscripten_set_touchcancel_callback_on_thread,
  ...
  pa: _emscripten_set_window_title,
  ...
  s: _glUseProgram,
  ua: _glVertexAttrib1fv,
  ta: _glVertexAttrib2fv,
  sa: _glVertexAttrib3fv,
  ra: _glVertexAttrib4fv,
  c: _glVertexAttribPointer,
  n: _glViewport,
  y: _glfwCreateWindow,
  ha: _glfwDefaultWindowHints,
  z: _glfwGetPrimaryMonitor,
  e: _glfwGetTime,
  ga: _glfwGetVideoModes,
  ia: _glfwInit,
  T: _glfwMakeContextCurrent,
  Z: _glfwSetCharCallback,
  U: _glfwSetCursorEnterCallback,
  X: _glfwSetCursorPosCallback,
  aa: _glfwSetDropCallback,
  ja: _glfwSetErrorCallback,
  _: _glfwSetKeyCallback,
  Y: _glfwSetMouseButtonCallback,
  W: _glfwSetScrollCallback,
  $: _glfwSetWindowContentScaleCallback,
  ba: _glfwSetWindowFocusCallback,
  ca: _glfwSetWindowIconifyCallback,
  le: _glfwSetWindowShouldClose,
